...
$api 	= $duap_options['duap_api_url'];
$apiId 	= $duap_options['duap_api_id'];
$apiKey = $duap_options['duap_api_key'];
...
function getProducts($format) {
	...
	if ($format == "xml")
		...
		return getJson($apiId, $apiKey, "Products", "pageSize=300");
}

// Example method: GET quantity list in xml or json
...
// Example method: GET products list in xml or json
...
function addPurchaseLineXml($lines, $lineNumber, $productCode, $qty, $price, $taxRate) {
	...
	$tax->addChild('Rate', $taxRate);
        ...
        // Create a sales invoice line XML object
	    function addSalesInvoiceLineXml($lines, $lineNumber, $productCode, $qty, $price, $taxRate) {
