<?php
	...
	class WC_Prdctfltr_Shortcodes {
		...
		function __construct() {
			...
			add_shortcode( 'prdctfltr_sc_products', array( &$this, 'prdctfltr_sc_products' ) );
			add_shortcode( 'prdctfltr_sc_get_filter', array( &$this, 'prdctfltr_sc_get_filter' ) );

			add_action('wp_ajax_nopriv_prdctfltr_respond', array( &$this, 'prdctfltr_respond' ) );
			add_action('wp_ajax_prdctfltr_respond', array( &$this, 'prdctfltr_respond' ) );
